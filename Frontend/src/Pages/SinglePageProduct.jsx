...
export const SinglePageProduct = () => {
  ...
  if (loading) return <p className="p-10 text-center text-gray-500">Loading product...</p>;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white p-8 rounded-3xl shadow-xl">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2"><FaShieldAlt /> Genuine Product</div>
          ...
          <div className="my-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {relatedProducts.slice(0, 4).map((p) => {
                const relatedInCart = items.some((item) => item.product._id === p._id);
                  ...
                  >
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        if (relatedInCart) {
                          dispatch(removeFromCart({ productId: p._id }));
                        } else {
