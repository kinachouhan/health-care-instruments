...
export const Footer = () => {
    return (
        <footer className="bg-gray-900 text-gray-200">
            <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 grid grid-cols-1 md:grid-cols-3 gap-15">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Link to="/about" className="hover:text-blue-400 transition text-gray-400">About</Link>
                    <Link to="/contact" className="hover:text-blue-400 transition text-gray-400">Contact</Link>
